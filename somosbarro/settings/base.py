"""
Django settings for somosbarro project.
...
SECRET_KEY = 'django-insecure-otl^p+&enw#_$5y(lp5a75ofry-*a=3vy)h+8se_dnsy1lak7@'
...
WSGI_APPLICATION = 'somosbarro.wsgi.application'
